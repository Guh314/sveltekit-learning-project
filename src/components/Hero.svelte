...
<SectionWrapper>
    ...
    <div class="flex flex-col gap-10 flex-1 items-center justify-center pb-10 md:pb-14">
        ...
        <p class="text-xl sm:text-2xl md:text-3xl text-center max-w-[1000px] mx-auto w-full">
            Less thinking & more doing. We're the trainer in your pocket full of <span class="italic">personalized workouts, exercises explanations analytics</span> and much much more.
        </p>
        <CTAs/>
